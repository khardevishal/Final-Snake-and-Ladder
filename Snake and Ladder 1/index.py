...
snk1 = pygame.image.load("snk1im.jpg")
snk2 = pygame.image.load("snk2im.jpg")
snk3 = pygame.image.load("snk3im.jpg")
snk4 = pygame.image.load("snk4im.jpg")
snk5 = pygame.image.load("snk5im.jpg")

#info of snakes
snk1Inf = pygame.image.load("snk1Info.jpg")
snk2Inf = pygame.image.load("snk2info.jpg")
snk3Inf = pygame.image.load("snk3Info.jpg")
snk4Inf = pygame.image.load("snk4info.jpg")
snk5Inf = pygame.image.load("snk5info.jpg")
...
button10 = pygame.draw.rect(GD,black,[40,250,250,50])
button20 = pygame.draw.rect(GD,black,[350,250,250,50])
button30 = pygame.draw.rect(GD,black,[650,250,250,50])
button40 = pygame.draw.rect(GD,black,[950,250,250,50])
button50 = pygame.draw.rect(GD,black,[35,560,250,50])


#Button to play game
button_play = pygame.draw.rect(GD,black,[1200,650,250,50])
    ...
    while not exit_game:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if(button30.collidepoint(mouse_pos)):
                    while not home_Window:
                        GD.blit(snk3Inf,(0,0))
                        pygame.display.update()
                ...
                if(button40.collidepoint(mouse_pos)):
                    while not home_Window:
                        GD.blit(snk4Inf,(0,0))
                        pygame.display.update()
                ...
                if(button50.collidepoint(mouse_pos)):
                    while not home_Window:
                        GD.blit(snk5Inf,(0,0))
                        pygame.display.update()
        ...
        #GD.blit(snk1Inf,(40,40))
        GD.blit(snk1,(40,40))
        GD.blit(snk2,(350,40))
        GD.blit(snk3,(650,40))
        GD.blit(snk4,(950,40))
        GD.blit(snk5,(40,350))
        #GD.blit(snk5,(1250,40))
        #draw_button()
        text_screen("Indian Cobra",red,40,250)
        text_screen("Mambas",red,360,250)
        text_screen("Viper",red,650,250)
        text_screen("Inland Taipan",red,950,250)
        text_screen("Green Anaconda",red,35,560)

        text_screen("Game",black,1200,650)
        #GD.blit(button1,(40,40))
        pygame.display.update()
        clock.tick(7)
